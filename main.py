...
def main():
    ...
    t.gen_text(f"Copyright (C) {year_now}, \x1b[31ml-senor Softwares Inc.\x1b[0m", 2)
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("l-senor", 3, contin=True)
    ...
    git_user_details = gifos.utils.fetch_github_stats("l-senor", ignore_repos)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101ml-senor@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mUbuntu Linux, macOS 15, Windows 11 \x1b[0m
    \x1b[96mHost:   \x1b[93mUniversity of Science and Technology Liaoning \x1b[0m
    \x1b[96mKernel: \x1b[93mComputer Science \x1b[0m
    \x1b[96mIDE:    \x1b[93mvim, VSCode\x1b[0m
    
    \x1b[30;101mContact:\x1b[0m
    --------------
    \x1b[96mEmail:      \x1b[93ml.senor@outlook.com\x1b[0m
    \x1b[96mZhihu:      \x1b[93msenor\x1b[0m
    ...
    \x1b[96mTotal Commits ({int(year_now)}): \x1b[93m{git_user_details.total_commits_last_year}\x1b[0m
    ...
    t.gen_typing_text(" -u l-senor", 1, contin=True)
